...
export default function Home() {
  ...
  const waterlooPurplePCB =
    isUWaterloo && expandedItem === 'education' ? (
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <div className="absolute top-0 h-4 w-full bg-[#5D0096] opacity-30"></div>
      </div>
    ) : null;
  ...
  return (
    <ThemeStyleProvider>
      ...
      <main
        className={`relative z-10 min-h-screen bg-gradient-to-b ${colors.primary} px-4 py-12 transition-colors duration-500 sm:px-6 lg:px-8`}
      >
        <div className="mx-auto max-w-4xl">
          ...
          <section id="about">
            <AboutSection
              bio={isTldrMode ? profileData.tldrBio : profileData.bio}
            />
          </section>
          <section id="skills">
          ...
          <section id="professional">
            <ProfessionalExperienceSection
              experiences={profileData.professionalExperiences as Experience[]}
            />
          </section>
          ...
          {!isTldrMode && (
            <section id="coop">
              <CoopExperienceSection
                experiences={profileData.coopExperiences as Experience[]}
              />
            </section>
          )}
          <section id="contact">
