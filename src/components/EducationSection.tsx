    ...
    return (
        ...
        >
            ...
            <div
                ...
                onKeyDown={(e) => handleKeyDown(e, handleEducationClick)}
                tabIndex={0}
                aria-label={`${education.university} - ${
            ...
            >
                <div className="flex justify-between items-center">
                    <div>
                        <h3
                            className={`font-medium text-lg ${colors.text} education-school`}
                        >
                    ...
                    education.coursework.length > 0 && (
                        <div className="mt-4 pt-4 border-t border-gray-200">
                            ...
                            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                                {(isTldrMode && education.tldrCoursework
                                    ? education.tldrCoursework
                                    : education.coursework
                                ).map((course, index) => (
