...
export const themes: Record<ThemeType, ThemeColors> = {
  ...
  uwaterloo: {
    ...
    specialBackground: "bg-[url('/pcb-pattern.svg')] bg-repeat bg-opacity-10", // Purple PCB pattern
  ...
  roblox: {
    ...
    buttonStyle: 'bg-gray-700 text-white px-4 py-2 rounded-md hover:bg-black',
